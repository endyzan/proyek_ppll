...
<body id="top">
            ...
            <div class="container">
                ...
                <div class="header-actions">
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <div class="header-action-btn profile-dropdown" id="profileDropdown">
                            <ion-icon name="person-circle-outline" style="font-size: 24px; cursor: pointer;"></ion-icon>
                ...
                <nav class="navbar">
                    <ul class="navbar-list">
                        ...
                        <li>
                            <a href="#discovery"
                                class="navbar-link has-after">discovery</a>
                        </li>
                        <li>
                            <a href="blog.php"
    ...
    <main>
        <article>
                        ...
                        <li class="scrollbar-item">
                            <div class="shop-card">
                                <div class="card-banner img-holder" style="--width: 540; --height: 720">
                                    <img src="admin/product/upload/<?php echo $p['image']; ?>" width="540" height="720" loading="lazy" alt="<?php echo $p['name']; ?>" class="img-cover" />
                                ...
                                <div class="card-content">
                                    <div class="price">
                                        <span class="span">Rp <?php echo number_format($p['price'], 0, ',', '.'); ?></span>
                                    </div>

                                    <h3>
                                        <a href="#" class="card-title"><?php echo $p['name']; ?></a>
                                    </h3>
            ...
            <section class="section shop" id="shop" aria-label="shop"
                ...
                <div class="container">
                    ...
                    <?php
                    include "config.php";
                    $result = mysqli_query($conn, "SELECT * FROM product WHERE price < 100000 ORDER BY id DESC");
                    while ($p = mysqli_fetch_assoc($result)) {
                    ?>
                        <li class="scrollbar-item">
                            <div class="shop-card">
      ...
      -->
            ...
            <section class="section blog" id="discovery" aria-label="blog"
                data-section>
                <div class="container">
                    ...
                    <ul class="flex-list">
                        ...
                        <li class="flex-item">
                            <div class="blog-card">
                                ...
                                <a href="./admin/discovery/discovery_user.php" class="btn-link">
